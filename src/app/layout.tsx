        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `
              ...
              })(window, document,'script','https://mc.yandex.ru/metrika/tag.js?id=105992559', 'ym');

              ym(105992559, 'init', {ssr:true, webvisor:true, clickmap:true, ecommerce:"dataLayer", accurateTrackBounce:true, trackLinks:true});
            `,
          }}
        />
        <script
