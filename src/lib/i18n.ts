...
export const dict: Record<Lang, Record<string, string>> = {
  ...
  final_cta_title: "Готовы к прорыву?",
    final_cta_lead: "Начните увеличивать продажи уже сегодня. Первые результаты увидите через 2 часа после запуска.",
  ...
  kk: {
   ...
   final_cta_title: "Секіруге дайынсыз ба?",
    final_cta_lead: "Бүгін-ақ сатылымдарды көбейтуді бастаңыз. Алғашқы нәтижелерді іске қосқаннан кейін 2 сағат ішінде көресіз.",
